...
/>
  ...
  <!--    
            ...
            for example:
              - tcdl1_to_xhtml_user_en.xslt (for English),
              - tcdl1_to_xhtml_user_en.xslt (for German),
              - etcetera.
...
.debug { color: #f00; } 
      ...
      <body lang="{$language}" xml:lang="{$language}">
        ...
        <h1>
          ...
          <span class="batchPosition" lang="{$language}"><xsl:call-template name="getTestTitle" /></span>
          (<span class="testTitle">
            ...
            <xsl:value-of select="btw:formalMetadata/btw:title" />
          </span>)
        </h1>
        ...
        <div id="usertest">
          ...
          <xsl:if test="btw:testCase/btw:requiredTests/btw:scenario[normalize-space(@id=$scenarioID)]/btw:userGuidance[@xml:lang=$language]">
            <h2><xsl:call-template name="getInstructionsTitle" /></h2>
            <div class="instructions">
              <xsl:for-each select="btw:testCase/btw:requiredTests/btw:scenario[@id=normalize-space($scenarioID)]/btw:userGuidance[@xml:lang=$language]/btw:p">
          ...
          <div class="testcase">
            ...
            <xsl:choose>
              ...
              <xsl:when test="$varTestFileCount &gt; 1">
                ...
                <ul>
                  <xsl:for-each select="btw:testCase/btw:files/btw:file">
                    <li>
                      <a href="{./@xlink:href}">
              ...
              <xsl:otherwise>
                ...
                <p>
                  ...
                  <a href="{btw:testCase/btw:files/btw:file/@xlink:href}">
              ...
              <xsl:when test="$testScenario/btw:questions/btw:yesNoQuestion">
                ...
                <p class="yesno">
                  <input type="radio" name="yesOrNo" id="yesRadio" 
                    value="{normalize-space($testScenario/btw:questions/btw:yesNoQuestion/btw:optionYes/@value)}" /><label for="yesRadio"><xsl:call-template name="getYes" /></label>
                    <xsl:text disable-output-escaping="yes">&lt;br /></xsl:text>
                  <input type="radio" name="yesOrNo" id="noRadio"
                    value="{normalize-space($testScenario/btw:questions/btw:yesNoQuestion/btw:optionNo/@value)}" /><label for="noRadio"><xsl:call-template name="getNo" /></label>
                </p>
              </xsl:when>
              ...
              <xsl:when test="$testScenario/btw:questions/btw:openQuestion">
                ...
                <p class="open">
                  ...
                  <textarea id="usertext" 
                    ...
                    onblur="if(this.value=='')this.value='&#8230;';"><xsl:text disable-output-escaping="yes">&amp;#8230;</xsl:text></textarea>
                </p>
              </xsl:when>
        ...
        <xsl:if test="starts-with($DEBUG, 'true')">
          <div class="debug">
            <xsl:if test="starts-with($testMode, 'enduser')">
              <p class="debug"><strong>User testing!</strong>
               $testScenario/@id = <xsl:value-of select="$testScenario/@id" /> ($scenarioID = <xsl:value-of select="$scenarioID"/>).</p>
             </xsl:if>
            <p class="debug">varTestFileCount: <xsl:value-of select="$varTestFileCount"/>.</p>
            <p class="debug">param testsuite: <xsl:value-of select="$testsuite"/>.</p>
            <p class="debug">fullTestSuiteName: <xsl:call-template name="getFullTestSuiteName" />.</p>
          </div>
        </xsl:if>
